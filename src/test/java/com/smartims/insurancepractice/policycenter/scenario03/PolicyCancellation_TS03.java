...
public class PolicyCancellation_TS03 {
    void policyCancellation(ChromeDriver driver, Actions action) throws IOException {
		 PolicyCancellationVO cvo = new  PolicyCancellationVO();
		 cvo.setPolicyCancellationReasonDescription(ExcelUtils_TS03.getCellValueByLabel("policyCancellationReasonDescription"));
		 cvo.setPolicyCancellationSource(ExcelUtils_TS03.getCellValueByLabel("policyCancellationSource"));
		 cvo.setPolicyCancellationReason(ExcelUtils_TS03.getCellValueByLabel("policyCancellationReason"));
		 cvo.setPolicyCancellationReasonDescription(ExcelUtils_TS03.getCellValueByLabel("policyCancellationReasonDescription"));	
