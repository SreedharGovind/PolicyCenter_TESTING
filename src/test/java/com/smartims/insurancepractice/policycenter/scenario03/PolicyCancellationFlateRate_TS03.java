...
public class PolicyCancellationFlateRate_TS03 {
	void policyCancellation2(ChromeDriver driver, Actions action) throws IOException {
		...
		cvo.setPolicyCancellationReasonDescription(
				ExcelUtils_TS03.getCellValueByLabel("policyCancellationFlatRateReasonDescription"));
		cvo.setCancellationEffectiveDate(ExcelUtils_TS03.getCellValueByLabel("cancellationEffectiveDateFlatRate"));
		cvo.setPolicyCancellationBindOptions(
				ExcelUtils_TS03.getCellValueByLabel("policyCancellationFlatRateBindOptions"));
		rfo.setRewriteFullTermOfferingsSelection(
				ExcelUtils_TS03.getCellValueByLabel("rewriteFullTermOfferingsSelection"));
		...
		driver.findElement(By.name(ConstantsClass03.rewriteofferingselection))
				.sendKeys(rfo.getRewriteFullTermOfferingsSelection(), Keys.TAB);
