...
import PolicyCenterTransactions.ConstantsClass03;
		...
		pco.setPolicyChangeVehicle1AIExisingPersonIntrestType(ExcelUtils_TS06.getCellValueByLabel("policyChangeVehicle1AIExisingPersonIntrestType"));
		pco.setPolicyChangeExistingDriverdateOfBirth(ExcelUtils_TS06.getCellValueByLabel("policyChangeOOSExistingDriverdateOfBirth"));
		pco.setPolicyChangeVehicle1CostNew(ExcelUtils_TS06.getCellValueByLabel("policyChangeOOSVehicle1CostNew"));
		pco.setPolicyChangeVehicle1MedicalPaymentsLimit(ExcelUtils_TS06.getCellValueByLabel("policyChangeVehicle1MedicalPaymentsLimit"));
	 ...
	 driver.findElement(By.xpath(ConstantsClass03.changevehicleexistingPersonInteresttype)).sendKeys(pco.getPolicyChangeVehicle1AIExisingPersonIntrestType(), Keys.TAB);
	 driver.findElement(By.id(ConstantsClass03.policychangenext)).click();
	 Thread.sleep(2000);
	 driver.findElement(By.id(ConstantsClass03.policychangenext)).click();	 
		 driver.findElement(By.id(ConstantsClass03.quote1)).click();
		 Thread.sleep(2000);
		 driver.findElement(By.xpath("/html/body/form/div/div[2]/div[2]/div[1]/div[3]/div[2]/div[7]/div/div[2]")).click();
		 ...
		 driver.findElement(By.id(ConstantsClass03.policychangenext)).click();
		 Thread.sleep(2000);
		 driver.findElement(By.name(ConstantsClass03.changeDOB1)).sendKeys(pco.getPolicyChangeExistingDriverdateOfBirth(), Keys.TAB);
		 driver.findElement(By.id(ConstantsClass03.policychangenext)).click();
		 driver.findElement(By.name(ConstantsClass03.changecostnew)).clear();
		 driver.findElement(By.name(ConstantsClass03.changecostnew)).sendKeys(pco.getPolicyChangeVehicle1CostNew(), Keys.TAB);
		 Thread.sleep(2000);		
		 ...
		 driver.findElement(By.id(ConstantsClass03.policychangenext)).click();
		 Thread.sleep(2000);
		 driver.findElement(By.xpath(ConstantsClass03.medicalLimit)).sendKeys(pco.getPolicyChangeVehicle1MedicalPaymentsLimit(), Keys.TAB);
