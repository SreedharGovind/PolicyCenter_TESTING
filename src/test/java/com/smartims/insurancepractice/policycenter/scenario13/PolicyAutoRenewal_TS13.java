...
public class PolicyAutoRenewal_TS13 {
	void policyRenewal(ChromeDriver driver, Actions actions) throws Exception {

		PolicyAutoRenewalVO pr = new PolicyAutoRenewalVO();

		pr.setTestingSystemClockDate(ExcelUtils_TS13.getCellValueByLabel("TestingSystemClockDate"));
		pr.setTestingSystemClockTime(ExcelUtils_TS13.getCellValueByLabel("TestingSystemClockTime"));
