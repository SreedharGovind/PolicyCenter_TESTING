...
public class PolicyIssuance_TS21 {
	...
	void submission21(ChromeDriver driver, Actions actions) throws IOException {
		...
		svo.setQuoteType(ExcelUtils_TS21.getCellValueByLabel("quoteType"));
		svo.setDefaultBaseState(ExcelUtils_TS21.getCellValueByLabel("defaultBaseState"));
		svo.setDefaultEffectiveDate(ExcelUtils_TS21.getCellValueByLabel("defaultEffectiveDate"));

		svo.setOfferingsSelection(ExcelUtils_TS21.getCellValueByLabel("offeringsSelection"));
		svo.setIsApplicantCurrentlyInsured(ExcelUtils_TS21.getCellValueByLabel("isApplicantCurrentlyInsured"));

		svo.setEffectiveDate(ExcelUtils_TS21.getCellValueByLabel("effectiveDate"));

		svo.setSNIFirstname(ExcelUtils_TS21.getCellValueByLabel("SNIFirstname"));
		svo.setSNIFirstname(ExcelUtils_TS21.getCellValueByLabel("SNIFirstname"));
		svo.setSNILastname(ExcelUtils_TS21.getCellValueByLabel("SNILastname"));
		svo.setSNIAddressLine1(ExcelUtils_TS21.getCellValueByLabel("SNIAddressLine1"));
		svo.setSNIState(ExcelUtils_TS21.getCellValueByLabel("SNIState"));
		svo.setSNIZipcode(ExcelUtils_TS21.getCellValueByLabel("SNIZipcode"));
		svo.setSNIAddressType(ExcelUtils_TS21.getCellValueByLabel("SNIAddressType"));

		svo.setANIFirstname(ExcelUtils_TS21.getCellValueByLabel("ANIFirstname"));

		svo.setDriver1Firstname(ExcelUtils_TS21.getCellValueByLabel("driver1Firstname"));
		svo.setDriver1Lastname(ExcelUtils_TS21.getCellValueByLabel("driver1Lastname"));
		svo.setDriver1dateOfBirth(ExcelUtils_TS21.getCellValueByLabel("driver1dateOfBirth"));
		svo.setDriver1Address1(ExcelUtils_TS21.getCellValueByLabel("driver1Address1"));
		svo.setDriver1ZIPCode(ExcelUtils_TS21.getCellValueByLabel("driver1ZIPCode"));
		svo.setDriver1LicenseNumber(ExcelUtils_TS21.getCellValueByLabel("driver1LicenseNumber"));
		svo.setDriver1LicenseState(ExcelUtils_TS21.getCellValueByLabel("driver1LicenseState"));
		svo.setDriver1YearFirstLicensed(ExcelUtils_TS21.getCellValueByLabel("driver1YearFirstLicensed"));

		svo.setVehicle1VIN(ExcelUtils_TS21.getCellValueByLabel("vehicle1VIN"));
		svo.setVehicle1LicenseState(ExcelUtils_TS21.getCellValueByLabel("vehicle1LicenseState"));
		svo.setVehicle1Driver1Percentage(ExcelUtils_TS21.getCellValueByLabel("vehicle1DriversPercentage"));
		svo.setVehicle1CostNew(ExcelUtils_TS21.getCellValueByLabel("vehicle1CostNew"));

		svo.setVehicle1AINewPersonIntrestType(ExcelUtils_TS21.getCellValueByLabel("vehicle1AINewPersonIntrestType"));

		svo.setVehicle1Collision(ExcelUtils_TS21.getCellValueByLabel("vehicle1Collision"));
		svo.setVehicle1Comprehensive(ExcelUtils_TS21.getCellValueByLabel("vehicle1Comprehensive"));
