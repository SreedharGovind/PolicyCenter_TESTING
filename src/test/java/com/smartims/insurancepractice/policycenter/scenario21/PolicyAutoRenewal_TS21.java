...
public class PolicyAutoRenewal_TS21 {
	void policyRenewal(ChromeDriver driver, Actions actions) throws Exception {

		PolicyAutoRenewalVO pr = new PolicyAutoRenewalVO();

		pr.setTestingSystemClockDate(ExcelUtils_TS21.getCellValueByLabel("TestingSystemClockDate"));
		pr.setTestingSystemClockTime(ExcelUtils_TS21.getCellValueByLabel("TestingSystemClockTime"));
