...
public class PolicyIssuance_TS02 {
	...
	public void policyCreation(ChromeDriver driver, Actions actions) throws IOException, InterruptedException {
		...
		pvo.setDefaultEffectiveDate(ExcelUtils_TS02.getCellValueByLabel("defaultEffectiveDate"));
		...
		pvo.setOfferingsSelection(ExcelUtils_TS02.getCellValueByLabel("offeringsSelection"));
		...
		pvo.setDriver1YearFirstLicensed(ExcelUtils_TS02.getCellValueByLabel("driver1YearFirstLicensed"));
		...
		pvo.setDriver1NumberOfAccidentsPolicyLevel(
				ExcelUtils_TS02.getCellValueByLabel("driver1NumberOfAccidentsPolicyLevel"));
		...
		pvo.setDriver1NumberOfAccidentsAccountLevel(
				ExcelUtils_TS02.getCellValueByLabel("driver1NumberOfAccidentsAccountLevel"));
		...
		pvo.setDriver1NumberOfViolationsPolicyLevel(
				ExcelUtils_TS02.getCellValueByLabel("driver1NumberOfViolationsPolicyLevel"));
		...
		pvo.setDriver1NumberOfViolationsAccountLevel(
				ExcelUtils_TS02.getCellValueByLabel("driver1NumberOfViolationsAccountLevel"));
		...
		pvo.setVehicle1Type(ExcelUtils_TS02.getCellValueByLabel("vehicle1Type"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleType)).sendKeys(pvo.getVehicle1Type());
		pvo.setVehicle1VIN(ExcelUtils_TS02.getCellValueByLabel("vehicle1VIN"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleVIN)).sendKeys(pvo.getVehicle1VIN());
		pvo.setVehicle1LicenseState(ExcelUtils_TS02.getCellValueByLabel("vehicle1LicenseState"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleLicenseState)).sendKeys(pvo.getVehicle1LicenseState());
		pvo.setVehicle1GaragedAt(ExcelUtils_TS02.getCellValueByLabel("vehicle1GaragedAt"));
		...
		pvo.setVehicle1Driver1Assignment(ExcelUtils_TS02.getCellValueByLabel("vehicle1Driver1Assignment"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleDriverAssignment))
				.sendKeys(pvo.getVehicle1Driver1Assignment());
		pvo.setVehicle1Driver1Percentage(ExcelUtils_TS02.getCellValueByLabel("vehicle1Driver1Percentage"));
		...
		driver.findElement(By.xpath(ConstantsClassPC.vehicleAdd)).click();
		pvo.setVehicle1Type(ExcelUtils_TS02.getCellValueByLabel("vehicle2Type"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleType)).sendKeys(pvo.getVehicle1Type());
		pvo.setVehicle1VIN(ExcelUtils_TS02.getCellValueByLabel("vehicle2VIN"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleVIN)).sendKeys(pvo.getVehicle1VIN());
		pvo.setVehicle1LicenseState(ExcelUtils_TS02.getCellValueByLabel("vehicle2LicenseState"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleLicenseState)).sendKeys(pvo.getVehicle1LicenseState());
		pvo.setVehicle1GaragedAt(ExcelUtils_TS02.getCellValueByLabel("vehicle2GaragedAt"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleGaragedAt)).sendKeys(pvo.getVehicle1GaragedAt());
		driver.findElement(By.id(ConstantsClassPC.assignDriver)).click();
		pvo.setVehicle1Driver1Assignment(ExcelUtils_TS02.getCellValueByLabel("vehicle2Driver1Assignment"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleDriverAssignment))
				.sendKeys(pvo.getVehicle1Driver1Assignment());
		pvo.setVehicle1Driver1Percentage(ExcelUtils_TS02.getCellValueByLabel("vehicle1Driver1Percentage"));
		driver.findElement(By.xpath(ConstantsClassPC.vehicleDriverPercentage)).clear();
