...
public class AccountCreation_TS12 {
	void createAccount(ChromeDriver driver, Actions action) throws Exception {
       ...
       AccountCreationVO avo = new AccountCreationVO();
		...
		avo.setFirstName(ExcelUtils_TS12.getCellValueByLabel("firstname"));
		avo.setLastName(ExcelUtils_TS12.getCellValueByLabel("lastname"));
		avo.setAddressLine1(ExcelUtils_TS12.getCellValueByLabel("addressLine1"));
		avo.setState(ExcelUtils_TS12.getCellValueByLabel("state"));
		avo.setAddressType(ExcelUtils_TS12.getCellValueByLabel("addressType"));
		avo.setOrganizationName(ExcelUtils_TS12.getCellValueByLabel("organizationName"));
