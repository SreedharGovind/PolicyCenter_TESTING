...
public class PolicyCancellation_TS11 {
	...
	public void policyCancellation(ChromeDriver driver, Actions actions) throws InterruptedException, IOException {
		...
		cvo.setPolicyCancellationSource(ExcelUtils_TS11.getCellValueByLabel("policyCancellationSource"));
		...
		cvo.setPolicyCancellationReason(ExcelUtils_TS11.getCellValueByLabel("policyCancellationReason"));
		...
		cvo.setCancellationEffectiveDate(ExcelUtils_TS11.getCellValueByLabel("cancellationEffectiveDate"));
		...
		cvo.setPolicyCancellationReasonDescription(
				ExcelUtils_TS11.getCellValueByLabel("policyCancellationReasonDescription"));
