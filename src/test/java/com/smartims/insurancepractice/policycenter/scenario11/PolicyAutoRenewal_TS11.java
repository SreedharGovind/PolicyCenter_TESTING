...
public class PolicyAutoRenewal_TS11 {
	void policyRenewal(ChromeDriver driver, Actions actions) throws Exception {

		PolicyAutoRenewalVO pr = new PolicyAutoRenewalVO();

		pr.setTestingSystemClockDate(ExcelUtils_TS11.getCellValueByLabel("TestingSystemClockDate"));
		pr.setTestingSystemClockTime(ExcelUtils_TS11.getCellValueByLabel("TestingSystemClockTime"));
