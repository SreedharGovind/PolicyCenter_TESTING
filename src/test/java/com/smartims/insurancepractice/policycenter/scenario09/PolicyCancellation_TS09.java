...
public class PolicyCancellation_TS09 {
	PolicyCancellationVO cvo = new PolicyCancellationVO();

	public void policyCancellation(ChromeDriver driver, Actions actions) throws Exception {
		...
		cvo.setPolicyCancellationSource(ExcelUtils_TS09. getCellValueByLabel("policyCancellationSource"));
		...
		cvo.setPolicyCancellationReason(ExcelUtils_TS09. getCellValueByLabel("policyCancellationReason"));
		...
		cvo.setPolicyCancellationReasonDescription(
				ExcelUtils_TS09. getCellValueByLabel("policyCancellationReasonDescription"));
