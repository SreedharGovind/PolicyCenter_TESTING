...
public class PolicyCancellation_TS19 {

	void policyCancellation19(ChromeDriver driver, Actions actions) throws IOException, InterruptedException {
		...
		pc.setPolicyCancellationSource(ExcelUtils_TS19.getCellValueByLabel("policyCancellationSource"));
		pc.setPolicyCancellationReason(ExcelUtils_TS19.getCellValueByLabel("policyCancellationReason"));
		pc.setPolicyCancellationReasonDescription(
				ExcelUtils_TS19.getCellValueByLabel("policyCancellationReasonDescription"));
		pc.setCancellationEffectiveDate(ExcelUtils_TS19.getCellValueByLabel("policyCancellationEffectiveDate"));
