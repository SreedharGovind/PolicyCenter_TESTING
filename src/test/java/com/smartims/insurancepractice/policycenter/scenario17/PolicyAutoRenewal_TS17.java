...
public class PolicyAutoRenewal_TS17 {
	void policyRenewal(ChromeDriver driver, Actions actions) throws Exception {

		PolicyAutoRenewalVO pr = new PolicyAutoRenewalVO();

		pr.setTestingSystemClockDate(ExcelUtils_TS17.getCellValueByLabel("TestingSystemClockDate"));
		pr.setTestingSystemClockTime(ExcelUtils_TS17.getCellValueByLabel("TestingSystemClockTime"));
