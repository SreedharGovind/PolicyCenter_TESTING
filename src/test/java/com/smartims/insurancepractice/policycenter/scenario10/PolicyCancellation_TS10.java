...
public class PolicyCancellation_TS10 {
	...
	public void policyCancellation(ChromeDriver driver, Actions actions) throws InterruptedException, IOException {
		...
		cvo.setPolicyCancellationSource(ExcelUtils_TS10.getCellValueByLabel("policyCancellationSource"));
		...
		cvo.setPolicyCancellationReason(ExcelUtils_TS10.getCellValueByLabel("policyCancellationReason"));
		...
		cvo.setPolicyCancellationReasonDescription(
				ExcelUtils_TS10.getCellValueByLabel("policyCancellationReasonDescription"));
