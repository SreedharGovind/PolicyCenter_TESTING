...
public class PolicyRewriteMidTerm_TS05 {
     ...
     rvo.setRewriteMidTermOfferingsSelection(ExcelUtils_TS05.getCellValueByLabel("rewriteMidTermOfferingsSelection")); 
     ...
     driver.findElement(By.xpath(ConstantsClassPC.rewriteMidTermOfferingsSelection )).sendKeys(rvo.getRewriteMidTermOfferingsSelection(), Keys.TAB);
