...
public class PolicyChange_TS05 {
			 ...
			 driver.findElement(By.name(ConstantsClass03.policychangepniaddressline1)).sendKeys(pco.getPolicyChangePNIAddressLine1(), Keys.TAB);
			 driver.findElement(By.id(ConstantsClass03.policychangeEdit)).click();
			 driver.findElement(By.id("PolicyChangeWizard-LOBWizardStepGroup-PolicyChangeWizard_PolicyInfoScreen-PolicyChangeWizard_PolicyInfoDV-AdditionalNamedInsuredInputSet-NamedInsuredsLV-0-_Checkbox")).click();
			 driver.findElement(By.id("PolicyChangeWizard-LOBWizardStepGroup-PolicyChangeWizard_PolicyInfoScreen-PolicyChangeWizard_PolicyInfoDV-AdditionalNamedInsuredInputSet-NamedInsuredsLV_tb-Remove")).click();
			 driver.findElement(By.id(ConstantsClass03.changenext)).click();
			 driver.findElement(By.xpath("/html/body/form/div/div[2]/div[2]/div[2]/div/div[5]/table/tbody/tr/td/div/div[2]/div[2]/div/div/div/div[9]/div[2]/div/div/input")).clear();	 
		     driver.findElement(By.xpath("/html/body/form/div/div[2]/div[2]/div[2]/div/div[5]/table/tbody/tr/td/div/div[2]/div[2]/div/div/div/div[9]/div[2]/div/div/input")).sendKeys(pco.getPolicyChangePNIDOB(), Keys.TAB);
