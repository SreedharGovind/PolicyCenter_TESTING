...
public class Cancellation_TS25 {
	...
	public void policyCancellation(ChromeDriver driver, Actions actions) throws InterruptedException, IOException {
		...
		cvo.setPolicyCancellationSource(ExcelUtils_TS25.getCellValueByLabel("policyCancellationSource"));
		...
		cvo.setPolicyCancellationReason(ExcelUtils_TS25.getCellValueByLabel("policyCancellationReason"));
		...
		cvo.setCancellationEffectiveDate(ExcelUtils_TS25.getCellValueByLabel("cancellationEffectiveDate"));
		...
		cvo.setPolicyCancellationReasonDescription(
				ExcelUtils_TS25.getCellValueByLabel("policyCancellationReasonDescription"));
