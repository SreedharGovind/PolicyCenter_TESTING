...
public class PolicyCancellation_TS22 {
	void policyCancellation22(ChromeDriver driver, Actions actions) throws IOException {
//	public static void main(String[] args) throws IOException {
		...
		pc.setPolicyCancellationSource(ExcelUtils_TS22.getCellValueByLabel("policyCancellationSource"));
		pc.setPolicyCancellationReason(ExcelUtils_TS22.getCellValueByLabel("policyCancellationReason"));
		pc.setPolicyCancellationReasonDescription(
				ExcelUtils_TS22.getCellValueByLabel("policyCancellationReasonDescription"));
		pc.setCancellationEffectiveDate(ExcelUtils_TS22.getCellValueByLabel("policyCancellationEffectiveDate"));
