...
public class PolicyManualRenewal_TS04 {
	void policyrenew(ChromeDriver driver, Actions action) throws IOException, InterruptedException {
		...
		driver.findElement(By.id(
				"RenewalWizard-LOBWizardStepGroup-LineWizardStepSet-PADriversScreen-JobWizardToolbarButtonSet-EditPolicyWorkflow"))
				.click();
		Thread.sleep(2000);
		driver.findElement(By.id("RenewalWizard-Next")).click();
		driver.findElement(By.xpath(
				"/html/body/form/div/div[2]/div[2]/div[2]/div/div[5]/div/div[3]/div[2]/div[2]/div/div/div/select"))
				.sendKeys(aro.getPolicyRenewTermType(), Keys.TAB);
		driver.findElement(By.id(
				"RenewalWizard-LOBWizardStepGroup-RenewalWizard_PolicyInfoScreen-JobWizardToolbarButtonSet-QuoteTypeToolbarButtonSet-Quote"))
				.click();
		WebElement bindoptions = driver.findElement(By.id(
		...
		bindoptions.click();
		driver.findElement(
				By.xpath("/html/body/form/div/div[2]/div[2]/div[1]/div[3]/div[2]/div[7]/div[3]/div[2]/div/div[2]"))
				.click();
