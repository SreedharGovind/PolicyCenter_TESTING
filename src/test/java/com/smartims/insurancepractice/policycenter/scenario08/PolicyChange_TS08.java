...
public class PolicyChange_TS08 {
	...
	public void perfromPolicyChange(ChromeDriver driver, Actions actions) throws IOException, InterruptedException {
		...
		pvo.setPolicyChangeDriver1dateOfBirth(ExcelUtils_TS08.getCellValueByLabel("policyChangeDriver1dateOfBirth"));
		driver.findElement(By.xpath(ConstantsClassPC_TS08.policyChangeDriver1dateOfBirth))
		...
		pvo.setPolicyChangeDriver1YearFirstLicensed(
				ExcelUtils_TS08.getCellValueByLabel("policyChangeDriver1YearFirstLicensed"));
		driver.findElement(By.xpath(ConstantsClassPC_TS08.existingDriverYearFirstLicensed))
				.sendKeys(pvo.getPolicyChangeDriver1YearFirstLicensed());
