...
public class PolicyReinstatement_TS23 {
	public void policyReinstatement(ChromeDriver driver, Actions actions) throws IOException {
		...
		reinstateVO.setReinstatementReason(ExcelUtils_TS23.getCellValueByLabel("reinstatementReason"));
		...
		reinstateVO.setReinstatementReasonDescription(
				ExcelUtils_TS23.getCellValueByLabel("reinstatementReasonDescription"));
