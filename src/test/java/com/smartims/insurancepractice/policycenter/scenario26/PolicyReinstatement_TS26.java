...
public class PolicyReinstatement_TS26 {
	public void policyReinstatement(ChromeDriver driver, Actions actions) throws IOException {
		...
		reinstateVO.setReinstatementReason(ExcelUtils_TS26.getCellValueByLabel("reinstatementReason"));
		...
		reinstateVO.setReinstatementReasonDescription(
				ExcelUtils_TS26.getCellValueByLabel("reinstatementReasonDescription"));
